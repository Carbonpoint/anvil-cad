...
pub fn paint(id: &str, painter: &Painter, rect: Rect, color: Color32) -> bool {
    ...
    match id {
        ...
        "select_body" => {
            c.poly_closed(&[(0.2, 0.35), (0.5, 0.2), (0.8, 0.35), (0.8, 0.7), (0.5, 0.85), (0.2, 0.7)]);
            c.line((0.2, 0.35), (0.5, 0.5));
            c.line((0.8, 0.35), (0.5, 0.5));
            c.line((0.5, 0.5), (0.5, 0.85));
        }
        "select_face" => {
            c.poly_closed(&[(0.15, 0.7), (0.6, 0.7), (0.85, 0.3), (0.4, 0.3)]);
            c.dot((0.5, 0.5));
        }
        "select_edge" => {
            c.poly_closed(&[(0.15, 0.7), (0.6, 0.7), (0.85, 0.3), (0.4, 0.3)]);
            c.line((0.15, 0.72), (0.6, 0.72));
            c.line((0.15, 0.76), (0.6, 0.76));
        }
